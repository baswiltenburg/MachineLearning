...
class N2000_DataPreparation():          
    ...
    def DevideData2(self, path_dataset, test_size = 0.1, validation_size = 0.15):
        ...
        # Number of arrays for testing
        test_amount = int(test_size * len(imgs_train))

        # Generate a random sample for test-set
        indexes_test = random.sample(all_indexes, test_amount)
