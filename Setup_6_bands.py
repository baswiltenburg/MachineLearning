...
dest_folder_cir = work_directory + "/Data/5_TrainingData/Gras/Images/From_model/2016_2017_RgbCirAhn/cir"
dest_folder_rgb = work_directory + "/Data/5_TrainingData/Gras/Images/From_model/2016_2017_RgbCirAhn/rgb"
...
cir_path = work_directory + "/Data/5_TrainingData/Gras/Images/From_model/2016_2017_RgbCirAhn/cir"
...
rgb_path = work_directory + "/Data/5_TrainingData/Gras/Images/From_model/2016_2017_RgbCirAhn/rgb"
...
csv_folder_rgb = work_directory + "/Data/5_TrainingData/Gras/Images/From_model/2016_2017_RgbCirAhn/rgb"
csv_folder_cir = work_directory + "/Data/5_TrainingData/Gras/Images/From_model/2016_2017_RgbCirAhn/cir"
...
rgb_path = work_directory + "/Data/5_TrainingData/Gras/Images/From_model/2016_2017_RgbCirAhn/rgb"
cir_path = work_directory + "/Data/5_TrainingData/Gras/Images/From_model/2016_2017_RgbCirAhn/cir"
dest_folder_rgb = work_directory + "/Data/5_TrainingData/Gras/Images/From_model/2016_2017_RgbCirAhn/rgb/normalized"
dest_folder_cir = work_directory + "/Data/5_TrainingData/Gras/Images/From_model/2016_2017_RgbCirAhn/cir/normalized"
### FOLDER NORMALIZATION STATS ### 
csv_rgb = work_directory + "/Data/5_TrainingData/Gras/Images/From_model/2016_2017_RgbCirAhn/rgb/NormalizationRGB.csv"
csv_cir = work_directory + "/Data/5_TrainingData/Gras/Images/From_model/2016_2017_RgbCirAhn/cir/NormalizationCIR.csv"
tiles = os.listdir(rgb_path)
for tile in tiles:
...
dest_folder_dsm = work_directory + "/Data/5_TrainingData/Gras/Images/From_model/2016_2017_RgbCirAhn/dsm"
dest_folder_dtm = work_directory + "/Data/5_TrainingData/Gras/Images/From_model/2016_2017_RgbCirAhn/dtm"
dsm = 'ahn3_05m_dsm'
dtm = 'ahn3_05m_dtm'
for i in range(len(ids)):
...
dest_folder_heigth = work_directory + "/Data/5_TrainingData/Gras/Images/From_model/2016_2017_RgbCirAhn/height"
dtm_path = work_directory + "/Data/5_TrainingData/Gras/Images/From_model/2016_2017_RgbCirAhn/dtm"
dsm_path = work_directory + "/Data/5_TrainingData/Gras/Images/From_model/2016_2017_RgbCirAhn/dsm"
...
path = work_directory + "/Data/5_TrainingData/Gras/Images/From_model/2016_2017_RgbCirAhn/dsm"
...
dest_folder = work_directory + "/Data/5_TrainingData/Gras/Images/From_model/2016_2017_RgbCirAhn/training_data"
dc.create6dimensionalImage(dest_folder_rgb, dest_folder_cir, dest_folder_heigth, dest_folder_slope, dest_folder, name = 'fromModel6Channels.tif')

### READ HEIGHT IMAGES IN 3 DIMENSIONAL NUMPY ARRAY ###
dest_path = work_directory + "/Data/5_TrainingData/Gras/Images/From_model/2016_2017_RgbCirAhn/training_data"
...
path_training_data = work_directory + "/Data/5_TrainingData/Gras/Images/From_model/2016_2017_RgbCirAhn/training_data"
path_mask_data = work_directory + "/Data/5_TrainingData/Gras/Images/From_model/2016_2017_RgbCirAhn/mask"
path_mask_data2 = work_directory + "/Data/5_TrainingData/Gras/Images/From_model/2016_2017_RgbCirAhn/mask"
tiles = os.listdir(path_training_data)
masks = os.listdir(path_mask_data)
for tile in tiles:
    if tile.endswith('.tif'):
        ...
        for mask in masks:
            if mask.endswith('mask.tif'):
                ...
                if mask_id == file_id:
                    ...
                    shutil.copy(f"{path_mask_data}/{mask}", (path_training_data+"/"+mask_name)) 
...
test_data = work_directory +  "/Data/5_TrainingData/Gras/Images/From_model/2016_2017_RgbCirAhn/training_data"
dp.CreateH5_files(test_data, name_file = "fromModel6Channels.h5")

### WRITE JSON FILE (OPTIONAL) ###
dc.saveImageDataToJson(image_directory = test_data, bounding_boxes_images = bounding_boxes, file_name = "fromModel6ChannelsTest.json")
